...
export interface ApiLibrairieLibrairie extends Struct.CollectionTypeSchema {
  collectionName: 'librairies';
  info: {
    displayName: 'Librairie';
    pluralName: 'librairies';
    singularName: 'librairie';
  };
  options: {
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    image: Schema.Attribute.Media<'files' | 'images' | 'videos'> &
      Schema.Attribute.Required;
    image_hover: Schema.Attribute.Media<'images'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::product.product'
    ...
    technic: Schema.Attribute.String;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::librairie.librairie': ApiLibrairieLibrairie;
